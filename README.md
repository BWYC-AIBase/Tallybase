...
- 透過 REYAX RYLR998 LoRa 模組**發射** Tally 狀態與配對資訊給燈具（燈具為接收端）
...
| 方向 | 發射 | 接收 | 用途 |
|------|------|------|------|
| 下行 | RYLR998（Gateway） | Tally 燈 SX1262 | Tally 狀態、配對／名稱 |
| 上行 | Tally 燈 SX1262 | RYLR998（Gateway） | MAC 廣播（Web UI 配對用） |
